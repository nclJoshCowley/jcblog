...
bibliography: rjags-and-quarto.bib
---
...
We store the following model specification in a text file named `bayes-lm.jags`

::: {.cell}
```{r}
#| echo = FALSE,
#| results = "asis"
cat("```{.r .cell-code}", readLines("bayes-lm.jags"), "```", sep = "\n")
```
:::
